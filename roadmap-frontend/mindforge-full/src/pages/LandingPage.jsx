...
const heroVideo =
  "https://res.cloudinary.com/dh3e5pick/video/upload/v1775414685/hero-bg_nwjjpe.mp4";
    ...
    <div className="min-h-screen bg-gradient-to-br from-secondary to-white text-dark">
      ...
      <section className="relative flex flex-col items-center justify-center text-center px-6 py-24 overflow-hidden">
        ...
        <div className="relative z-10 text-white justify-center">
          ...
          <p
            className="text-lg sm:text-xl max-w-2xl mx-auto mb-8 text-white text-center"
            data-aos="fade-up"
          >
            Unlock smarter learning paths with AI-driven skill detection,
            concept tracking, and revision tools.
          </p>
          <div className="flex gap-8 justify-center" data-aos="zoom-in">
            <Link
              to="/signup"
              className="bg-primary text-white px-6 py-3 rounded-md shadow-md hover:shadow-lg hover:bg-[#0f3c8c] transition-all"
            >
              Get Started
            </Link>
            <Link
              to="/login"
              className="bg-accent text-white px-6 py-3 rounded-md shadow-md hover:shadow-lg hover:bg-orange-600 transition-all"
            >
              Login
            </Link>
          </div>
      ...
      <section className="bg-[#f5faff] py-24 px-6">
        <div className="max-w-6xl mx-auto text-center mb-16">
          ...
          <p
            ...
            data-aos-delay="100"
          >
            Discover the core strengths that make MindForgeAI a smarter and
            more personalized AI learning platform.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: "Learn at your own pace, on your own schedule. MindForgeAI eliminates unnecessary steps and delivers what you need—when you need it.",
              bg: Card1,
            },
            {
              title: "Focused on Personalization",
              desc: "Stop learning what you already know. MindForgeAI adapts to your skill level and progress, guiding you straight to what matters most.",
              bg: Card2,
            },
            {
              title: "AI-Powered Efficiency",
              desc: "Our intelligent system analyzes your performance in real-time and delivers bite-sized, personalized lessons — saving you hours of ineffective studying.",
              bg: Card3,
            },
          ].map((item, idx) => (
            <div
      ...
      <section className="relative px-6 py-24 bg-gradient-to-r from-secondary to-[#eef7ff] text-center">
        ...
        <p
          ...
          data-aos-delay="100"
        >
          MindForgeAI combines AI-driven diagnostics and personalized content to
          ensure your learning is efficient and tailored to your pace.
        </p>
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
          <div className="md:w-1/2" data-aos="fade-right">
            ...
            <p className="text-gray-700">
              MindForgeAI is your personal AI education platform — bridging the
              gap between confusion and confidence. From skill scanning to
              micro-lessons and adaptive revision, MindForge guides your
